...
export const THEME_RELEASE_INDEX_URL =
  "https://raw.githubusercontent.com/lovelyzy7/cf-server-monitor-theme-NieR/dist/index.html";

const LATEST_THEME_CACHE_KEY = "cfsm-nier:theme-latest-version";
const LATEST_THEME_TTL_MS = 12 * 60 * 60 * 1000;
const LATEST_THEME_FAILURE_TTL_MS = 60 * 60 * 1000;
const LATEST_THEME_TIMEOUT_MS = 8_000;

/** `Nier v1.0.0` → `1.0.0`；读不出返回 null。 */
