...
const RELEASE_HTML =
  '<!doctype html><html><head>\n  <meta name="theme-version" content="Nier v1.2.16" />\n  </head></html>';
...
describe("theme version parsing", () => {
  it("reads the version out of the build meta, both on this page and in the release html", async () => {
    ...
    expect(parseThemeVersionMeta("Nier v1.2.15")).toBe("1.2.15");
    expect(parseThemeVersionMeta("Nier")).toBeNull();
    expect(extractThemeVersionFromHtml(RELEASE_HTML)).toBe("1.2.16");

    document.head.innerHTML = '<meta name="theme-version" content="Nier v1.2.15" />';
